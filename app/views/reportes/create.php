      ...
      <form method="post" action="?controller=reportes&action=generarEmpleado">
        <div class="row">
          ...
          <div class="col-12 mt-3 d-flex justify-content-end">
            ...
            <a href="?controller=reportes&action=index" class="btn btn-secondary ms-2">Cancelar</a>
          </div>
        </div>
      </form>
    </div>
    ...
    <?php if (!empty($inspeccionSeleccionada)): ?>
      ...
      <div class="card mb-2">
        <div class="card-body">
          ...
          <div><strong>Actividad Económica:</strong> <?= isset($inspeccionSeleccionada['act_economica']) ? htmlspecialchars($inspeccionSeleccionada['act_economica']) : '<span class="text-muted">No disponible</span>' ?></div>
