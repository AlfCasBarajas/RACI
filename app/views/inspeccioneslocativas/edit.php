...
<div class="container mt-4">
  ...
  <form method="post" action="?controller=inspeccionlocativa&action=update&id=<?= $inspeccion['id_insp_loc'] ?>">
    <div class="row">
      ...
      <div class="col-md-4 mb-2"><label>ID Categoría</label><input type="number" name="categoria_id_categoria" class="form-control" value="<?= htmlspecialchars($inspeccion['categoria_id_categoria']) ?>"></div>
      <div class="col-md-4 mb-2"><label>ID Incidente</label><input type="number" name="incidente_id_incidente" class="form-control" value="<?= htmlspecialchars($inspeccion['incidente_id_incidente']) ?>"></div>
      <div class="col-md-4 mb-2"><label>ID Accidente</label><input type="number" name="accidente_id_accidente" class="form-control" value="<?= htmlspecialchars($inspeccion['accidente_id_accidente']) ?>"></div>
      <div class="col-md-4 mb-2"><label>ID Riesgo</label><input type="number" name="riesgo_id_riesgo" class="form-control" value="<?= htmlspecialchars($inspeccion['riesgo_id_riesgo']) ?>"></div>
      <div class="col-md-4 mb-2"><label>ID Reporte</label><input type="number" name="reporte_id_reporte" class="form-control" value="<?= htmlspecialchars($inspeccion['reporte_id_reporte']) ?>"></div>
