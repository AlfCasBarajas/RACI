                    ...
                    <div class="alert alert-danger alert-dismissible fade show" role="alert">
                        ...
                        switch($_GET['error']) {
                            case 'area_required':
                                ...
                                break;
                            case 'database_error':
                                echo '<i class="bi bi-exclamation-triangle me-2"></i>Error al guardar el accidente. Por favor inténtelo nuevamente.';
                                break;
                            default:
                        ...
                        <form method="post" action="?controller=accidentes&action=store">
                            ...
                            <div class="row">
                                <div class="col-md-12 mb-3">
                                    ...
                                    <div class="form-text">Seleccione el empleado involucrado en el accidente</div>
                                </div>
                            </div>
