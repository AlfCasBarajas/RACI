            ...
            <div style="border-radius: 1.2rem; box-shadow: 0 2px 12px rgba(30,40,90,0.10); background: #fff; border: none; padding: 2rem; margin-top: 2rem;">
                <div class="d-flex align-items-center mb-4">
                    ...
                    <h2 style="color: #1a237e; font-weight: 700; margin: 0;">
                        <i class="bi bi-building me-2"></i>Editar Área
                    </h2>
                </div>
                        ...
                        <form method="post" action="?controller=areas&action=update&id=<?= $area['id_area'] ?>">
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control" id="nombre" name="nombre" 
                                       ...
                                       placeholder="Ej: Producción, Administración, etc." required>
                            </div>
                            <div class="mb-3">
                                <label for="descripcion" class="form-label fw-semibold">Descripción</label>
                                <textarea class="form-control" id="descripcion" name="descripcion" rows="4" 
                                          placeholder="Descripción detallada del área..."><?= htmlspecialchars($area['descripcion']) ?></textarea>
                            </div>
                            ...
                            <div class="d-flex gap-2 justify-content-end">
                                ...
                                <button type="submit" class="btn btn-primary">
                                    <i class="bi bi-check-circle me-1"></i>Actualizar Área
                                </button>
                            </div>
                        </form>
                    </div>
